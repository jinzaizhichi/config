...
function M.setup(client, bufnr)
    ...
    M.set_keymap(bufnr, 'n', '<leader>i', '<cmd>lua vim.lsp.diagnostic.show_line_diagnostics()<CR>', opts)
    M.set_keymap(bufnr, 'n', '[i', '<cmd>lua vim.lsp.diagnostic.goto_prev()<CR>', opts)
    M.set_keymap(bufnr, 'n', ']i', '<cmd>lua vim.lsp.diagnostic.goto_next()<CR>', opts)
