...
function M.setup(client, bufnr)
    ...
    M.set_keymap(bufnr, 'n', '<C-k>', '<cmd>lua vim.lsp.buf.signature_help()<CR>', opts)
    ...
    M.set_keymap(bufnr, 'n', 'gr', '<cmd>lua vim.lsp.buf.references()<CR>', opts)
    M.set_keymap(bufnr, 'n', '<leader>e', '<cmd>lua vim.lsp.diagnostic.show_line_diagnostics()<CR>', opts)
    M.set_keymap(bufnr, 'n', '[d', '<cmd>lua vim.lsp.diagnostic.goto_prev()<CR>', opts)
    M.set_keymap(bufnr, 'n', ']d', '<cmd>lua vim.lsp.diagnostic.goto_next()<CR>', opts)
    M.set_keymap(bufnr, 'n', '<leader>q', '<cmd>lua vim.lsp.diagnostic.set_loclist()<CR>', opts)
    M.set_keymap(bufnr, 'n', '<leader>ca', "<Cmd>lua require('jdtls').code_action()<CR>", opts)
    M.set_keymap(bufnr, 'v', '<leader>ca', "<Cmd>lua require('jdtls').code_action(true)<CR>", opts)
