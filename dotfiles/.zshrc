...
alias mks='minikube start --docker-env HTTP_PROXY=http://192.168.31.227:8118 --docker-env HTTPS_PROXY=http://192.168.31.227:8118 --docker-env NO_PROXY=localhost,127.0.0.1,localaddress,.localdomain.com,10.96.0.0/12,192.168.99.0/24,192.168.39.0/24,192.168.49.2/24'
alias mk='minikube'
alias ll='ls -lah'
alias la='ls -a'
